 ...
 * slot.
 *
 * With zero links the composed chain **is** the terminal instance (identity),
 * so behavior is byte-identical to the pre-chain spine \u2014 the empty-links case
 * this Step 4 always hits.
 */
